...
def main():
    ...
    parser.add_argument(
        '--output_folder',
        default='/path/ScanNet-md40/scannet_instance_data',
        help='output folder of the result.')
    parser.add_argument(
        '--train_scannet_dir', default="/path/scannet/scans/", help='scannet data directory.')
    parser.add_argument(
        '--test_scannet_dir',
        default="/path/scannet/scans_test/",
        help='scannet data directory.')
    parser.add_argument(
        '--label_map_file',
        default='/path/scannet/scannetv2-labels.combined.tsv',
    ...
    parser.add_argument(
        ...
        default="/path/scannet/meta_data/scannetv2_test.txt",
        help='The path of the file that stores the scan names.')
